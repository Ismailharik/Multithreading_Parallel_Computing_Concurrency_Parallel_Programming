...
//		TimeUnit.SECONDS.sleep(2);
        ...
        thread.join();//join method also put our main thread in wait state until this threas will be completely finished
        System.out.println("in main() - leaving");// this line will always printed last,
    }
}